...
public class TicTacToe {
	...
	if(b1==1&&b2==1&&b3==1)
	{
		JOptionPane.showMessageDialog(frmTictactoe, "Congratulations..  The winner is X","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
		cntofx1++;
		countofx.setText(String.valueOf(cntofx1));
	}
	...
	{
		JOptionPane.showMessageDialog(frmTictactoe, "Congratulations..  The winner is O","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
		cntofo1++;
		countofo.setText(String.valueOf(cntofo1));
	}
	...
	private void initialize() {
		...
		frmTictactoe.setBounds(100, 100, 753, 473);
		...
		exitbt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frmTictactoe, "Do you want to exit?","Tic Tac Toe",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
				{
					System.exit(0);
				}
			}
