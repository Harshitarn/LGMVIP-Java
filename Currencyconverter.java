		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 Double convert;
			        ...
			        if(comboBox.getSelectedItem().toString()=="INR" && comboBox_1.getSelectedItem().toString()=="USD"){
			            convert = amount* 0.012;
			            JOptionPane.showMessageDialog(null, "The amount is: "+convert.toString()+" USD");
			        }
			        else if(comboBox.getSelectedItem().toString()=="INR" && comboBox_1.getSelectedItem().toString()=="EURO"){
			            convert = amount * 0.011;
			            JOptionPane.showMessageDialog(null, "The amount is: "+convert.toString()+" EURO");
			        }
			        else if(comboBox.getSelectedItem().toString()=="USD" && comboBox_1.getSelectedItem().toString()=="INR"){
			            convert = amount * 82.75;
			            JOptionPane.showMessageDialog(null, "The amount is: "+convert.toString()+" INR");
			        }
			        else if(comboBox.getSelectedItem().toString()=="USD" && comboBox_1.getSelectedItem().toString()=="EURO"){
			            convert = amount * 0.93;
			            JOptionPane.showMessageDialog(null, "The amount is: "+convert.toString()+" EURO");
			        }
			        else if(comboBox.getSelectedItem().toString()=="EURO" && comboBox_1.getSelectedItem().toString()=="INR"){
			            convert = amount * 88.79;
			            JOptionPane.showMessageDialog(null, "The amount is: "+convert.toString()+" INR");
			        }
			        else if(comboBox.getSelectedItem().toString()=="EURO" && comboBox_1.getSelectedItem().toString()=="USD"){
			            convert = amount * 1.07;
			            JOptionPane.showMessageDialog(null, "The amount is: "+convert.toString()+" USD");
			        }
